		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				...
				<li class="sidebar-header">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="javascript:void();" onclick="loadPage('faculty/weeklyreport.php','maincontent'); setActive(this);">
							  <i class="align-middle" data-feather="book"></i> <span class="align-middle">Weekly Report</span>
						</a>
					</li>
